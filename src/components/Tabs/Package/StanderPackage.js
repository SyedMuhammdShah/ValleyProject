  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <Grid container spacing={1}>
        ...
        <Grid item xs={5}>
        <img src={spic1} className="HoverImage" alt="Logo" style={{width:'321px', height:'421px'}} />
      ...
      <Grid container spacing={1}>
        ...
        <img src={BigPic} alt="Logo" className="HoverImage" style={{width:'151px', height:'151px'}}  />
        </Grid>
        <Grid item xs={1}>
