...
import Ani from '../ProductAnimation/ProAni'
...
export const Home = () => {
  return (
    <div className="MainClass">
      ...
      <p style={{ fontSize: "20px", fontWeight: 700, marginBottom:'10px'}} className="TreadHeading">
          Treading:
        </p>
      ...
      <div class="TradHeading">
        <div
          className="herodiv1"
          style={{ marginLeft: "64px", marginTop: "100px" }}
        >
        ...
        <div class="flex-TextImage">
          <div className="TextImaHeading">
            <p className="TextPara">
              The ultimate fitness app <br/> that's a cut above the rest
            </p>
            <br />
